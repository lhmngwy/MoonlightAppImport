...
9. Enable **"Ping server"** if your Sunshine server can be pinged and you want to check if the server is online before doing an API call. **Note: On Windows 11 hosts ping might be disabled by default. [Either enable it in your firewall](https://superuser.com/questions/1683853/cannot-ping-a-windows-11-machine) or deactivate this checkbox.**
10. Run **Library ▸ Update Game Library ▸ Moonlight App Import**.
11. The plugin fetches all configured apps from the host and adds them to Playnite.
